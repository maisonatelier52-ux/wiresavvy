...
export async function generateMetadata({ params }) {
  ...
  const articles = details.articles.filter(a => a.authorId.toString() === id);

  return {
    title: `${author.name} — Author at Wiresavvy`,
    description:
      author.bio ||
      `Read news articles and reports written by ${author.name} on Wiresavvy.`,
    keywords: [
      author.name,
      "Wiresavvy author",
      "US news writers",
    ...
    openGraph: {
      ...
      url: `https://wiresavvy.com/authors/${id}`,
      type: "profile",
      images: [
        {
          url: author.photo || "/default-author.webp",
          width: 600,
          height: 600,
          alt: author.name,
        },
    ...
    twitter: {
      ...
      description: author.bio,
      images: [author.photo || "/default-author.webp"],
    },
    alternates: {
      canonical: `https://wiresavvy.com/authors/${id}`,
    },
  };
}
...
export default async function AuthorPage({ params }) {
  ...
  const authorArticles = details.articles.filter(a => a.authorId.toString() === id);
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="flex gap-6 items-start">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-3 leading-relaxed max-w-xl">
              {author.bio}
            </p>
          ...
          {authorArticles.map((article) => (
            ...
            >
              ...
              <img
                src={article.image}
                alt={article.title}
                className="w-32 h-24 object-cover group-hover:opacity-80 transition"
              />

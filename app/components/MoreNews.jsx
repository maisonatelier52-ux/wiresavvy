  ...
  return (
    <section className="w-full mb-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-5">
        ...
        <Link href={`/${first.category}/${first.slug}`} title={first.title} className="sm:col-span-1">
        ...
        <Link href={`/${second.category}/${second.slug}`} title={second.title} className="sm:col-span-2">
        ...
        <Link href={`/${third.category}/${third.slug}`} title={third.title} className="sm:col-span-1">
          <div className="bg-white h-full">
            {third.image && (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 py-5 gap-5">
        ...
        <Link href={`/${fourth.category}/${fourth.slug}`} title={fourth.title} className="sm:col-span-2">
          <div className="relative w-full h-[260px] md:h-[320px] lg:h-[380px] flex flex-col justify-end p-5 text-white overflow-hidden">
            <img
              src={fourth.image}
              alt={fourth.title}
        ...
        <Link href={`/${fifth.category}/${fifth.slug}`} title={fifth.title} className="sm:col-span-1">
          <div className="bg-white h-full">
            {fifth.image && (
        ...
        <Link href={`/${sixth.category}/${sixth.slug}`} title={sixth.title} className="sm:col-span-1">

    ...
    <>
      ...
      >
        ...
        <nav className="flex flex-col text-sm flex-grow overflow-y-auto max-h-screen">
          ...
          {/* OTHER LINKS */}
          <Link href="/business" className="px-4 py-3 hover:text-red-500 border-b border-gray-200" title="Business">Business</Link>
          <Link href="/travel" className="px-4 py-3 hover:text-red-500 border-b border-gray-200" title="Travel">Travel</Link>
          <Link href="/lifestyle" className="px-4 py-3 hover:text-red-500 border-b border-gray-200" title="Lifestyle">Lifestyle</Link>
          <Link href="/law" className="px-4 py-3 hover:text-red-500 border-b border-gray-200" title="Law">Law</Link>
          <Link href="/finance" className="px-4 py-3 hover:text-red-500 border-b border-gray-200" title="Finence">Finance</Link>
          <Link href="/investigation" className="px-4 py-3 hover:text-red-500" title="Investigation">Investigation</Link>
          <Link href="/world" className="px-4 py-3 hover:text-red-500" title="World">World</Link>
